/**
 * ANCIENNE PAGE D'ACCUEIL — place de marche.
 *
 * Elle n'est plus routee : tant que `MARKETPLACE_PUBLIQUE` vaut false, la
 * racine sert la landing de la caisse (voir src/app/page.tsx). Ce fichier est
 * conserve intact pour pouvoir rallumer la place de marche sans le reecrire :
 * il suffira de le redeplacer en src/app/page.tsx et de repasser le drapeau a
 * true. Ne pas le supprimer.
 */
 ...
 */
export const metadataMarketplace = {
